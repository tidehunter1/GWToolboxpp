...
#include <GWCA/GameEntities/GwDat.h>      // For texture loading
...
// AgentNameCache, Utf8ToWide, ParseSemicolonNameList, etc. stay exactly as you had them.
...
public:
	...
	void Initialize(ImGuiContext* ctx, ImGuiAllocFns allocator_fns, HMODULE toolbox_dll) override {
		...
		if (auto* texModule = GW::GwDat::GetTextureModule()) {
...
private:
	...
	void RefreshPriorityBuffersAndLists() { /* your existing function */ }
	std::optional<ImU32> GetPriorityColor(const std::wstring& name_lower) const { /* your existing function */ }

	void DrawNameplates() { /* your existing function - unchanged except it calls updated DrawBar */ }
	...
	// ... keep your other helper functions (ShouldShowAllegiance, WithinRange, WorldToScreen, ColorFor, etc.)
